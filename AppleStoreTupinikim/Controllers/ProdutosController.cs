...
namespace AppleStoreTupinikim.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdProduto,modelo,valor,usado")] Produtos produtos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProduto,modelo,valor,usado")] Produtos produtos)
        {
