...
namespace AppleStoreTupinikim.Controllers
{
    public class LoginsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,nomeUsuario,email,senha")] Login login)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,nomeUsuario,email,senha")] Login login)
        {
            if (id != login.Id)
            {
                return NotFound();
